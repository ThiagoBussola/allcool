...
@Sql(scripts = {"/sql/achievement/achievement.sql", "/sql/coupon/coupon.sql"})
...
public class CouponRepositoryTest {
    ...
    public void findAll() {
        ...
        assertThat(couponList).extracting(Coupon::getValue).containsExactly(BigDecimal.valueOf(20.00), BigDecimal.valueOf(15.50));
    ...
    public void update() {
        ...
        assertThat(couponBeforeUpdate.getValue()).isEqualTo(BigDecimal.valueOf(20.00));
        ...
        couponBeforeUpdate.setValue(BigDecimal.valueOf(25.50));
        ...
        assertThat(couponAfterUpdate.getValue()).isEqualTo(BigDecimal.valueOf(25.50));
